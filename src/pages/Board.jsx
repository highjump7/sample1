        ...
        <div className="inner">
            ...
            <div className="board-table-wrap">
                <table>
                    ...
                    <colgroup>
                        <col className="board-number" /><col className="board-title" />
                        <col className="board-author" /><col className="board-date" />
                        <col className="board-views" />
                    </colgroup>
                    <thead><tr><th>번호</th><th>제목</th><th>작성자</th><th>작성일</th><th>조회</th></tr></thead>
                    <tbody>{boardData.map((item) => <BoardRow key={item.id} item={item} />)}</tbody>
                </table>
            </div>
